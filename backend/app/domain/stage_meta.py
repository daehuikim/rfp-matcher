...
STAGE_LABEL: dict[PipelineStage, str] = {
    ...
    PipelineStage.CANONICALIZING: "분류 정규화",
    PipelineStage.CANONICALIZED: "정규화 완료",
...
STAGE_SNIPPET: dict[PipelineStage, str] = {
    ...
    PipelineStage.CLASSIFYING: "요건구분·카테고리 라벨 추출 중…",
    PipelineStage.CANONICALIZING: "별칭·절단·taxonomy로 분류 정규화 중…",
